...
class JungHomeDataUpdateCoordinator(DataUpdateCoordinator[list[Device]]):
    ...
    def __init__(
        ...
        # over REST (`async_fetch_gateway_version`). The hub's `sw_version`, and
        # a device's only while its own firmware revision is unknown
        # (`sw_version_for`).
    ...
    def _apply_device_info(self) -> None:
        ...
        may happen before the gateway version, the verbose device properties
