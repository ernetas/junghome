...
# Consecutive failed reconnects before raising a repair issue, following the
# core convention of bounding push failures. Below this the backoff has waited well
